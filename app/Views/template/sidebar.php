    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="">Data Mata Pelajaran</a>
                <a class="collapse-item" href="">Data Kelas</a>
                <a class="collapse-item" href="">Data Tahun Ajaran</a>
                <a class="collapse-item" href="">Naik Kelas</a>
                <a class="collapse-item" href="">Kelulusan</a>
